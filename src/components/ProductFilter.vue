                ...
                <ul class="colors">
                    <li class="colors__item">
                        <label class="colors__label">
                            ...
                            <span class="colors__value" style="background-color: blue;">
                            </span>
                        </label>
                    </li>
                    <li class="colors__item">
                        <label class="colors__label">
                            ...
                            <span class="colors__value" style="background-color: gold;">
                            </span>
                        </label>
                    </li>
                    <li class="colors__item">
