                    ...
                    <form class="form" action="#" method="POST">
                            ...
                            <ul class="colors">
                                ...
                                <li class="colors__item">
                                    <label for="color_2" class="colors__label">
                                        <input id="color_2" class="colors__radio sr-only" type="radio" name="color-item"
                                            value="yellow">
                                ...
                                <li class="colors__item">
                                    <label for="color_3" class="colors__label">
                                        <input id="color_3" class="colors__radio sr-only" type="radio" name="color-item"
                                            value="gray">
                            ...
                            <ul class="sizes sizes--primery">
                                <li class="sizes__item">
                                    <label for="size_1" class="sizes__label">
                                        <input id="size_1" class="sizes__radio sr-only" type="radio" name="sizes-item"
                                            value="32">
                                ...
                                <li class="sizes__item">
                                    <label for="size_2" class="sizes__label">
                                        <input id="size_2" class="sizes__radio sr-only" type="radio" name="sizes-item"
                                            value="64">
                                        <span class="sizes__value">
                                            64gb
                                        </span>
                                ...
                                <li class="sizes__item">
                                    <label for="size_3" class="sizes__label">
                                        <input id="size_3" class="sizes__radio sr-only" type="radio" name="sizes-item"
                                            value="128" checked="true">
                                        <span class="sizes__value">
                                            128gb
                                        </span>
                                    </label>
                        ...
                        <div class="item__row">
                            <div class="form__counter">
                                ...
                                <label for="count_1">Count
                                    <input id="count_1" type="text" value="1" name="count">
                                </label>
